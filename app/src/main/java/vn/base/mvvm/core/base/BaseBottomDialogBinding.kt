...
abstract class BaseBottomDialogBinding<T : ViewBinding>(private val inflateMethod: (LayoutInflater, ViewGroup?, Boolean) -> T) :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NORMAL, vn.base.mvvm.ui.R.style.BottomDialog_Rounded)
    }
